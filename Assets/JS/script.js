...
$('.add-to-fav').click(function(e) {
    ...
    switch (addToFav) {
        case false:
            $(this).css('color', '#77C04B');
            $(this.childNodes[1]).removeClass('fa-heart-o');
            $(this.childNodes[1]).addClass('fa-heart');
            addToFav = true;
            break;
        default:
            $(this).css('color', '#fff');
            $(this.childNodes[1]).removeClass('fa-heart');
            $(this.childNodes[1]).addClass('fa-heart-o');
            addToFav = false;
    }
});

$('#nine-div').click(function() {
    $('.search-item-background').css('width', '100%');
    $('.search-item-details').css('width', '100%');
    $('.search-item-background').css('height', '70%');

    $('.search-item-background').css({
        'border-top-right-radius': '10px',
        'border-bottom-left-radius': 'unset'
    });

    $('.search-li').css('height', '350px');
    $('.search-li').css('width', '25%');
});
...
$('#three-div').click(function() {
    ...
    $('.search-li').css('height', '350px');
    $('.search-li').css('width', '33.3333%');
});

$('#one-div').click(function() {
    $('.search-item-background').css('width', '30%');
    $('.search-item-details').css('width', '70%');
    $('.search-item-background').css('height', '100%');
    ...
    $('.search-li').css('width', '100%');
    $('.search-li').css('height', '200px');
});
